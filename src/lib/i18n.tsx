...
export const messages: Dict = {
  ...
  "tree.optional": { ar: "اختياري", en: "optional" },
  "tree.noPrice": { ar: "بدون سعر — السعر عند الطلب", en: "No price — price on request" },
  "tree.roomType": { ar: "نوع الغرفة", en: "Room type" },
  "tree.hotel": { ar: "الفندق", en: "Hotel" },
  "tree.hotelCity": { ar: "مدينة الفندق", en: "Hotel city" },
  "tree.detailsAr": { ar: "التفاصيل (عربي)", en: "Details (Arabic)" },
  "tree.detailsEn": { ar: "التفاصيل (إنجليزي)", en: "Details (English)" },
